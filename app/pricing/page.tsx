...
const features: Array<{
  ...
  { label: 'TypeScript SDK', current: '0.12.0', evidence: 'Package manifest', limit: 'Compatibility paths are not firewall proof', next: 'Named-action intercept is not isolation' },
  { label: 'Python SDK', current: '0.12.0', evidence: 'Package manifest', limit: 'No TypeScript v1 parity claim', next: 'Compatibility fixes only' },
        ...
        <div className="container">
          <div className="price-grid">
            <div className="price-card">
              ...
              <div className="amount">0.12.0 <small>/ TypeScript</small></div>
              <ul>
            ...
            <div className="price-card featured">
              <h3>Python SDK</h3>
              <div className="amount">0.12.0 <small>/ Python</small></div>
              <ul>
