...
const features: Array<{
  ...
  { label: 'TypeScript SDK', current: '0.15.0', evidence: 'Package manifest', limit: 'Compatibility paths are not firewall proof', next: 'Named-action intercept is not isolation' },
  { label: 'Python SDK', current: '0.15.0', evidence: 'Package manifest', limit: 'No TypeScript v1 parity claim', next: 'Compatibility fixes only' },
